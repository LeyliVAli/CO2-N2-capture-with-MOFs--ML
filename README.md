...
The datasets used in this repository were derived from the ARC-MOF database (Burner et al., Chem. Mater. 2023), which provides MOF structures with DFT-derived partial atomic charges and precomputed chemical and geometric descriptors.
